<aside class="col-lg-3">
  ...
  <div class="widget">
    ...
    <ul class="comments-list">
      <li>
        <div class="alignleft">
          <a href="#0"><img src="<?= base_url() ?>assets/modal/img/blog-5.jpg" alt=""></a>
        </div>
      ...
      <li>
        <div class="alignleft">
          <a href="#0"><img src="<?= base_url() ?>assets/modal/img/blog-6.jpg" alt=""></a>
        </div>
        <small>11.08.2016</small>
        <h3><a href="#" title="">Verear qualisque ex minimum...</a></h3>
      </li>
      <li>
        <div class="alignleft">
          <a href="#0"><img src="<?= base_url() ?>assets/modal/img/blog-4.jpg" alt=""></a>
        </div>
        <small>11.08.2016</small>
        <h3><a href="#" title="">Verear qualisque ex minimum...</a></h3>
      </li>
